    ...
    <div class="productModal modal-background" v-if="isModalVisible || isModalClosing" @click="closeModal(true)">
      <section class="moreAboutProduct moreAboutProduct-other" @click.stop :class="modalClass" @animationend="endAnimation">
        ...
        <div class="moreAboutProduct-image">
          <img class="moreAboutProduct-image-img-alt" :src="img" alt="изображение продукта: команда /particle">
        </div>
        <div class="moreAboutProduct-direction">
          <button @click="closeModal">Главная</button>
          <span>></span>
          <button>Команда /particle</button>
        </div>
        <div class="moreAboutProduct-information">
          <p class="moreAboutProduct-information-title">Команда /particle</p>
          <div class="moreAboutProduct-information-price-section">
            <p class="moreAboutProduct-information-price">{{ price }}₽</p>
            <div class="moreAboutProduct-image-adaptive"><img class="moreAboutProduct-image-img-adaptive" :src="img" alt="изображение продукта: команда /particle"></div>
        ...
        <div class="moreAboutProduct-description">
          ...
          <div class="moreAboutProduct-description-subtitle">
            <p>Доступ к команде /particle. Задержка на использование составляет 10 секунд. Используйте как хотите, где хотите и когда хотите!  </p>
            <ul></ul>
          </div>
        </div>
      </section>
    ...
    <div class="productModal" v-if="isOrderModalVisible || isOrderModalClosing" @click="closeOrderModal(true)">
      <section class="orderProduct" @click.stop :class="orderModalClass" @animationend="endOrderAnimation">
        ...
        <div class="orderProduct-direction">
          ...
          <span>></span>
          <button @click="closeOrderModal">Команда /particle</button>
          <span>></span>
          <button>Оплата</button>
        </div>
        <div class="orderProduct-information-container">
          <div class="orderProduct-information">
            <p class="orderProduct-information-title">Команда /particle</p>
...
<script>
import productImg from '~/assets/img/particle.gif';
export default {
  ...
  data() {
    return {
      ...
      price: 500,
      purchaseLink: 'https://pay.enot.io/widget/89bd6d90-2d83-4a2c-8b88-c4329240c1a0/link',
      time: 'На весь сезон',
      img: productImg,
  ...
  methods: {
    ...
    selectOption(option) {
      ...
      if (option === 'fullSeason') {
        this.price = 500;
        this.purchaseLink = 'https://pay.enot.io/widget/89bd6d90-2d83-4a2c-8b88-c4329240c1a0/link';
