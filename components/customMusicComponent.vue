    ...
    <div class="productModal modal-background" v-if="isModalVisible || isModalClosing" @click="closeModal(true)">
      <section class="moreAboutProduct moreAboutProduct-other" @click.stop :class="modalClass" @animationend="endAnimation">
        ...
        <div class="moreAboutProduct-image">
          <img class="moreAboutProduct-image-img-alt" :src="img" alt="изображение продукта: кастомная музыка">
        </div>
        <div class="moreAboutProduct-direction">
          <button @click="closeModal">Главная</button>
          <span>></span>
          <button>Создание кастомной музыки</button>
        </div>
        <div class="moreAboutProduct-information">
          <p class="moreAboutProduct-information-title">Создание кастомной музыки</p>
          <div class="moreAboutProduct-information-price-section">
            <p class="moreAboutProduct-information-price">{{ price }}₽</p>
            <div class="moreAboutProduct-image-adaptive"><img class="moreAboutProduct-image-img-adaptive" :src="img" alt="изображение продукта: кастомная музыка"></div>
        ...
        <div class="moreAboutProduct-description">
          ...
          <div class="moreAboutProduct-description-subtitle">
            <p>Возможность создания кастомной музыки на пластинках с помощью команды /createMusic. Чтобы создать пластинку с кастомной музыкой, возьмите её в руку и введите команду /createMusic (вставьте URL для скачивания песни).  </p>
            <ul></ul>
          </div>
        </div>
      </section>
    ...
    <div class="productModal" v-if="isOrderModalVisible || isOrderModalClosing" @click="closeOrderModal(true)">
      <section class="orderProduct" @click.stop :class="orderModalClass" @animationend="endOrderAnimation">
        ...
        <div class="orderProduct-direction">
          ...
          <span>></span>
          <button @click="closeOrderModal">Создание кастомной музыки</button>
          <span>></span>
          <button>Оплата</button>
        </div>
        <div class="orderProduct-information-container">
          <div class="orderProduct-information">
            <p class="orderProduct-information-title">Создание кастомной музыки</p>
...
<script>
import productImg from '~/assets/img/music_dis.gif';
export default {
  ...
  data() {
    return {
      ...
      price: 300,
      purchaseLink: 'https://pay.enot.io/widget/4f5cdd42-458a-4980-81ff-1550c341fca6/link',
      time: 'На весь сезон',
      img: productImg,
  ...
  methods: {
    ...
    selectOption(option) {
      ...
      if (option === 'fullSeason') {
        this.price = 300;
        this.purchaseLink = 'https://pay.enot.io/widget/4f5cdd42-458a-4980-81ff-1550c341fca6/link';
